...
//        }
         ...
         * @return Returns either {@link AndroidIntentFilter#NO_MATCH_DATA},
         * {@link AndroidIntentFilter#MATCH_CATEGORY_PORT}, or
         * {@link AndroidIntentFilter#MATCH_CATEGORY_HOST}.
         */
     ...
     * against the filter, as described in {@link AndroidIntentFilter}; in that case,
...
//    public static final Parcelable.Creator<AndroidIntentFilter> CREATOR
//            = new Parcelable.Creator<AndroidIntentFilter>() {
//        public AndroidIntentFilter createFromParcel(Parcel source) {
//            return new AndroidIntentFilter(source);
//        }
//
//        public AndroidIntentFilter[] newArray(int size) {
//            return new AndroidIntentFilter[size];
//        }
//    };
...
//    private AndroidIntentFilter(Parcel source) {
//        mActions = new ArrayList<String>();
